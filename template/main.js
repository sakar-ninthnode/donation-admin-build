    ...
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](4, 1, ctx.page));
        }
      },
...
class DataService {
  ...
  getUsers(roleId, status, city, state, page, searchText) {
    const token = localStorage.getItem('authToken'); // Get token from localStorage
    let pageNum = page || 1;
    if (!token) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(() => new Error('No authentication token found'));
  ...
  getStates() {
    ...
    let apiUrl = `${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.BACKEND_URL}/admin/states`;
    const httpOptions = {
      headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpHeaders({
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
  ...
  getPincodeDetails(pincode) {
    return this.http.get(`https://api.postalpincode.in/pincode/${pincode}`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.map)(res => {
